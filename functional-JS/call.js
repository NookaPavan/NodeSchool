...
We can still use hasOwnProperty from the Object.prototype though, if we call it with the this value set to something that 'looks like an object'. Function#call allows us 
...
function duckCount() {
  ...
  However, it can be converted to a real Array:
    ...
    var args = Array.prototype.slice.call(arguments); OR
